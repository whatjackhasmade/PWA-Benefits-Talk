...
With the rise in use of mobile devices, there has been a clear divide between native mobile applications and online websites.
...
Challenging industries and challenging the decision to split into sub-segments within software development.
...
Mobile applications solve problems, providing a reliable solution for creating applications with capabilities to store large amounts of data and files offline.
...
The first commercially successful smartphone, the iPhone was released in 2007.

More than a decade later, web technologies have come a long way.

Challenging the need for native applications to solve new problems.

---

## So What Can the Web Do in 2018?
...
This update in support increased the scope of users that are able to take advantage of progressive website application technologies (service worker, manifest files, etc.).
